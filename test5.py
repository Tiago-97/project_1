...
arr_json = [x for x in os.listdir('/estagio/2ºdesafio') if x.endswith(".json")]
print(arr_json)
z=0
#print (arr_json[z])
y = arr_json[z]
...
for line in  file2:
	...
	if count == 20:
		...
		gene6=gene6.split('"')
		gene6 = gene6 [1]
print ("alelles: %s|%s|%s|%s|%s|%s" % (gene1,gene2,gene3,gene4,gene5,gene6))
...
print ("meio alelles: %s|%s|%s|%s|%s|%s" % (gene_1,gene_2,gene_3,gene_4,gene_5,gene_6))
